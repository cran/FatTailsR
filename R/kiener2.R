...
#' @title Asymmetric Kiener Distribution (Type II)
#'
#' @description
#' Density, distribution function, quantile function, random generation
#' and additional formulae for the Kiener distribution of type II.
#'
...
#'
#' @details
#' Kiener distributions of type II are distributions with asymmetric left
...
#' Karamata theorems. 
#'
#' As \code{a} and \code{w} are highly correlated, the use of Kiener 
#' distributions of type III (\code{k} and \code{d}) or type IV (\code{k} and 
#' \code{e}) is an alternate solution.
#' 
...
#' the asymmetric Kiener distributions of type III and IV 
